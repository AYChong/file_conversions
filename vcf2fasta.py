# Convert phased vcf genotype data to FASTA pseudosequences for haplotype network analysis
	...
	for line in vcf:
		if line.startswith("##"): # Skip info lines
			...
			try:
				...
				for genotype_info in genotype_list:
					genotype_call = genotype_info.split(":")[0]
